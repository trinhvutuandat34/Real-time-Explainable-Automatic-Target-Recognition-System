...
## First real Kaggle run of the detection pipeline — 2 crashes hit and fixed (2026-07-09)

The user ran the notebook end-to-end on Kaggle (Tesla T4, `real-time-ex-05`) and hit two real, sequential crashes — the first real execution of this session's detection-ingestion and Module A training code.
